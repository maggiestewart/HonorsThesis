...
/**
 * Servlet implementation class MeetingRooms
 */
public class MeetingRooms extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
  	...
  	//STEP 2: Register JDBC driver
  		try{
  			...
  			String heading = "<h2 style=\"text-align: center; padding-top:5%;\">Meeting Rooms"
  	  				+ "</h2><div class=\"intro\""
 			 ...
 			 while(rs.next()){
 				 ...
 				 String photoFile = "Images/meeting-rooms.jpeg";
 				 String description = rs.getString("description");
 				 String capacity = rs.getString("capacity");
 				 
 				String html = "<div class=\"grid-item\" style=\"width: 100%; margin:auto;cursor: pointer; padding-bottom: 5%;\">"
 						+ "<img src=\"" + photoFile + "\" style=\"width: 80%; border-radius: 2%;\"><br><h3>" + roomID + "</h3>"
 						+ "<h5>Room includes: " + description + "</h5>"
 						+ "<h5>" + capacity + "</h5>"
 				 ...
 				 if (availability.equals("Available")){
	 				form = "<form action=\"http://3.145.193.254:8080/LibraryBR/Reserve\" method=\"post\" style=\"width: 60%; margin: auto;\">"
	 							+ "<input type=\"hidden\" name=\"searchVal\" value=\"meeting\">"
					 			+ "<input type=\"hidden\" name=\"roomID\" value=\"" + roomID + "\">"
					 			+ "<input type=\"hidden\" name=\"currentDate\" value=\"" + currentDate + "\">"
					 			+ "<input type=\"hidden\" name=\"timePos\" value=\"0\">"
	 						+ "<button type=\"submit\">Reserve</button></form></div>";
