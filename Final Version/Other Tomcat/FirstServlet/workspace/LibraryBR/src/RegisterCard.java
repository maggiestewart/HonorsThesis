...
public class RegisterCard extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(first == null || last == null || birthday == null || email == null || password == null){
        	...
        	//STEP 2: Register JDBC driver
      		try{
      			...
      			String sql = "INSERT INTO userInfo(name, email, birthday, password, cardNumber, expirationDate) " +
        	...
        	// message = "<p>Registration complete! Your card number is "+ cardNo + 
        	//		". <br> Login <a href=\"18.222.29.185/LibraryBR/userLogin.html\" id=\"acct\" onclick=\"replaceHref('acct')\">here</a></p>";
        }
		...
		String htmlInfo = docType + "<html>"+
				...
				+ "case 'navAccount': case 'acct': case 'footerAccount': myAnchor.href = 'http://3.145.193.254:8080/LibraryBR/IsLoggedIn';break;"
    			...
    			"<div class=\"navbar\" style=\"background-color: #3E505B;\">"
    				...
    				"</div><h2><center>Welcome " + name + "!</h2>" +
    				"<center><p>Registration complete! Your card number is "+ cardNo + 
        			". <br> Login <a href=\"http://3.145.193.254:8080/LibraryBR/IsLoggedIn\" id=\"acct\" onclick=\"replaceHref('acct')\">here</a></p>" + 
