...
/**
 * Servlet implementation class StudyRooms
 */
public class StudyRooms extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
  	...
  	//STEP 2: Register JDBC driver
  		try{
  			...
  			String heading = "<h2 style=\"text-align: center; padding-top:5%;\">Study Rooms"
  	  				+ "</h2><div class=\"intro\""
 			 ...
 			 while(rs.next()){
 				...
 				String html = "<div class=\"grid-item\" style=\"width: 100%; margin:auto; padding-bottom: 5%;\">"
 						+ "<form action=\"http://3.145.193.254:8080/LibraryBR/ReserveStudy\" method=\"post\" style=\"width: 60%; margin: auto;\">"
 						+ "<input type=\"hidden\" name=\"roomID\" value=\"" + roomID + "\"><button type=\"submit\">"
 				 		+ "<img src=\"" + photoFile + "\" style=\"width: 80%\"></button></form><h3 style=\"text-align: center;\">" + roomID + "</h3>"
