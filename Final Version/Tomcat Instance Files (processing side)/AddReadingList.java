...
/**
 * Servlet implementation class AddReadingList
 */
public class AddReadingList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
  	...
  	//STEP 2: Register JDBC driver
  		try{
  			...
  			String sql = "INSERT INTO readinglist(cardNumber, shelfmark) "
  					+ "VALUES (\'" + cardNo + "\', \'" + shelf + "\');";
		...
		String heading = "<div class=\"e\" style=\"padding-top: 5%; padding-bottom: 5%; text-align: center; width: 80%; margin: auto;\">"
					+ "<h3>" + name + " was added to your reading list!</h3>";  			
		s.append(heading);	
			
		String end = "</div></div><div class=\"footer\" style=\"background-color: #3E505B;\"><a id=\"footerLogo\" href=\"18.222.29.185/LibraryBR/index.html\" onclick=\"replaceHref('footerLogo')\"><img src=\"Images/libraryLogo.svg\" style=\"height: 80px\" alt=\"LibraryBR\"></a>"
