	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
  	...
  	//STEP 2: Register JDBC driver
  		try{
  			...
  			String heading = "<h2 style=\"text-align: center; padding-top: 5%;\">Events for " + a + "</h2>"
  					+ "<div class=\"e\" style=\"padding-top: 5%; padding-bottom: 5%; text-align: center; width: 80%; margin: auto;\">";  			
  			s.append(heading);
			ResultSet rs = (ResultSet)stmt.executeQuery(sql);
 			 ...
 			 while(rs.next()){
 				...
 				String html = "<div class=\"c\" style=\"width: 80%; margin:auto; padding-bottom: 5%;\">"
